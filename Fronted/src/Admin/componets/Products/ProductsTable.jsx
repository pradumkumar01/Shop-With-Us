        ...
        <Grid container spacing={2}>
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value={"mensShoesPage1,top,mens_kurta,saree,lengha_page1"}>All Products</MenuItem>
                <MenuItem value={"top"}>Women Top</MenuItem>
                <MenuItem value={"mens_kurta"}>Men's Kurta</MenuItem>
                <MenuItem value={"mensShoesPage1"}>Shoes</MenuItem>
                <MenuItem value={"sareePage1"}>Saree</MenuItem>
                <MenuItem value={"lengha_page1"}>Lengha Choli</MenuItem>
                <MenuItem value={"dressPage1"}>Women Dress</MenuItem>
                <MenuItem value={"gounsPage1"}>Women Gouns</MenuItem>
                <MenuItem value={"kurtaPage1"}>Women Kurta</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={4}>
