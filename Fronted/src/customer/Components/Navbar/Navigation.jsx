            ...
            <div className="flex h-16 items-center px-11">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to="/">
                  ...
                  <img
                    src="https://image.freepik.com/free-vector/lettering-shop-with-us-vector-illustration_12196-158.jpg"
                    alt="ShopwithUs"
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {auth.user ? (
                    ...
                    <Button
                      onClick={handleOpen}
                      className="text-sm font-medium text-gray-700  hover:to-blue-900 "
                      gutterBotton
                    >
                      Signin
                    </Button>
                ...
                {/* Cart */}
                <div className="ml-4 flow-root lg:ml-6 text-pink-700">
                  <Button
